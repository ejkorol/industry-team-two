  ...
  return (
    <div className="upload">
      <div className="upload__image-wrapper">
        {!imagePreview && (
          <label htmlFor="image" className="upload__file-input-label">
            <span className="upload__image__span">+</span>Add photo
          </label>
        )}
        <input
        ...
        {imagePreview && (
          <img
            ...
            src={imagePreview}
            alt="work hard everyday, make few fucking money"
          />
        )}
      </div>
      <div className="image-label__wrapper">
        {!imagePreview && (
          <h3 className="image-label__text">
            Select an image that provides the best view of your item
          </h3>
        )}
        {imagePreview && (
          <div className="image-label__wrapper--with-button">
            <h3 className="image-label__text image-label__text--light">
      ...
      {imagePreview && (
        <div className="informative">
          ...
          <p className="informative__text">
            Our generative text uses popular keywords to ensure your listing
